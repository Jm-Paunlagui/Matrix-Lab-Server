...
# class CsvAnalysis(db.Model):
#     """
#     Csv Analysis Model class attributes
#     csv_id: Csv id number (primary key) (auto increment) bigint
#     csv_name: Csv name varchar(255)
#     csv_question: Csv question varchar(255)
#     csv_file_path: Csv file path text
...
#
#     def __repr__(self):
#         """Csv Analysis Model class representation."""
#         return f"CsvAnalysis(csv_id={self.csv_id}, csv_name={self.csv_name}, csv_question={self.csv_question}, " \
#                f"csv_file_path={self.csv_file_path}, school_year={self.school_year}, " \
#                f"school_semester={self.school_semester})"
#
#     # @desc: For Descending Order (newest to oldest) in the csvs_analysis table
#     def __lt__(self, other):
#         return self.csv_id < other.csv_id
#
#     # @desc: For Ascending Order (oldest to newest) in the csvs_analysis table
#     def __gt__(self, other):
#         return self.csv_id > other.csv_id
